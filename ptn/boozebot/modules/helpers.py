...
# import discord.py
import discord
from discord import Interaction, app_commands, Guild, Member, User, Role, Thread
...
async def get_role(role_id: int) -> Optional[discord.Role]:
...
async def get_emoji(emoji_id: int) -> Optional[discord.Emoji]:
