...
PROD_BC_PUBLIC_CHANNEL_IDS = [838699587249242162, 849460909273120856, 932918003639648306, 819295547289501736,
                              837764138692378634, 849249916676603944, 1078840174227763301, 1079384804098854972]
...
TEST_BC_PUBLIC_CHANNEL_IDS = [1107757218318782586, 1107757285817712721, 1107757340381425768, 1107757384069288056,
                              1107757418517110955, 1107757456517505055, 1107757490940153956, 1107757548779601940]
# booze-cruise-announcements, booze-cruise-departures, wine-cellar-unloading, booze-cruise-chat, wine-cellar-deliveries, wine-cellar-loading, booze-snooze-and-garage, Rackham’s Peak Tavern
...
any_elevated_role = [server_admin_role_id(), server_mod_role_id()]
somm_plus_roles = [server_sommelier_role_id(), *any_elevated_role]
conn_plus_roles = [server_connoisseur_role_id(), *somm_plus_roles]
wine_carrier_plus_roles = [server_wine_carrier_role_id(), *conn_plus_roles]